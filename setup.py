...
setup(
  ...
  download_url = 'https://github.com/treehousekingcomic/DiscordEmojiHandler/archive/v1.6.tar.gz',    # I explain this later on
  keywords = ['discord.py', 'emojis', 'handler'],   # Keywords that define your package best
  install_requires=[],
  classifiers=[
